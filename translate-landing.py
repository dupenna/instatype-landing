...
T = [
    ...
    ("Marque como global ou restrinja a um domínio. Templates do trabalho não invadem seu e-mail pessoal, snippets de código ficam só no GitHub.",
     "Mark as global or restrict to a single domain. Work templates don't invade your personal inbox, code snippets stay on GitHub.",
     "Marca como global o restríngela a un dominio. Plantillas de trabajo no invaden tu correo personal, fragmentos de código se quedan en GitHub."),
    ...
    ("Sim, em qualquer página com campos editáveis: inputs, textareas e divs <code>contenteditable</code>. Testado em editores rich-text como Gmail, Notion, Linear, Slack, Discord e WhatsApp Web.",
     "Yes, on any page with editable fields: inputs, textareas and <code>contenteditable</code> divs. Tested on rich-text editors like Gmail, Notion, Linear, Slack, Discord and WhatsApp Web.",
     "Sí, en cualquier página con campos editables: inputs, textareas y divs <code>contenteditable</code>. Probado en editores rich-text como Gmail, Notion, Linear, Slack, Discord y WhatsApp Web."),
