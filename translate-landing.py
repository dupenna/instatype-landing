...
T = [
    ...
    ("Sim, em qualquer página com campos editáveis: inputs, textareas e divs <code>contenteditable</code>. Testado em editores rich-text baseados nos principais frameworks da web (Lexical, ProseMirror, Slate, Draft.js, Quill).",
     "Yes, on any page with editable fields: inputs, textareas and <code>contenteditable</code> divs. Tested on rich-text editors built on the major web frameworks (Lexical, ProseMirror, Slate, Draft.js, Quill).",
     "Sí, en cualquier página con campos editables: inputs, textareas y divs <code>contenteditable</code>. Probado en editores rich-text basados en los principales frameworks de la web (Lexical, ProseMirror, Slate, Draft.js, Quill)."),
